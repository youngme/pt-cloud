...
public class AuthenticationService implements IAuthenticationService {
    ...
    public boolean decide(HttpServletRequest authRequest) {
        ...
        //获取此访问用户所有角色拥有的权限资源
        Set<Resources> userResources = findResourcesByUsername(authentication.getName());
     ...
     * @return
     */
    public boolean isMatch(ConfigAttribute urlConfigAttribute, Set<Resources> userResources) {
     ...
     * @return
     */
    private Set<Resources> findResourcesByUsername(String username) {
        //用户被授予的角色资源
        Set<Resources> resources = resourceService.queryByUsername(username);
